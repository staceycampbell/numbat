...
proc create_root_design { parentCell } {
  ...
  set all_moves_bram [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:bram_rtl:1.0 all_moves_bram ]
  ...
  set fan_ctrl_write [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:fifo_write_rtl:1.0 fan_ctrl_write ]
  ...
  # Create instance: all_moves_blk_mem, and set properties
  set all_moves_blk_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 all_moves_blk_mem ]
  set_property -dict [list \
  ...
  # Create instance: all_moves_bram_axi_ctrl, and set properties
  set all_moves_bram_axi_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 all_moves_bram_axi_ctrl ]
  set_property -dict [list \
    CONFIG.DATA_WIDTH {128} \
  ...
  # Create instance: am_axi_register_slice, and set properties
  set am_axi_register_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_register_slice:2.1 am_axi_register_slice ]
  set_property -dict [list \
    CONFIG.REG_AR {1} \
    CONFIG.REG_AW {1} \
    CONFIG.REG_B {1} \
  ] $am_axi_register_slice
...
1#UART 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#Gem 1#MDIO 1#MDIO 1#########################USB0 Reset#} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#sclk_out#gpio0[7]#gpio0[8]#n_ss_out[0]#miso#mosi#gpio0[12]#gpio0[13]#gpio0[14]#gpio0[15]#gpio0[16]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#gpio0[21]#gpio0[22]#gpio0[23]#scl_out#sda_out#gpi[0]#gpio1[27]#gpio1[28]#gpio1[29]#gpio1[30]#gpi[5]#gpio1[32]#gpio1[33]#gpio1[34]#gpo[3]#txd#rxd#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem1_mdc#gem1_mdio_out#########################reset#}\
\
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {333.33} \
...
\
  ...
  connect_bd_intf_net -intf_net BRAM_PORTB_0_1 [get_bd_intf_ports all_moves_bram] [get_bd_intf_pins all_moves_blk_mem/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net axi_register_slice_0_M_AXI [get_bd_intf_pins all_moves_bram_axi_ctrl/S_AXI] [get_bd_intf_pins am_axi_register_slice/M_AXI]
  ...
  connect_bd_intf_net -intf_net ps_e_M_AXI_HPM1_FPD [get_bd_intf_pins am_axi_register_slice/S_AXI] [get_bd_intf_pins ps_e/M_AXI_HPM1_FPD]
  connect_bd_intf_net -intf_net trans_axi_1 [get_bd_intf_ports trans_axi] [get_bd_intf_pins ps_e/S_AXI_HP1_FPD]

  # Create port connections
  connect_bd_net -net fan_ctrl_fifo_valid [get_bd_ports fan_ctrl_valid] [get_bd_pins fan_ctrl_fifo/valid]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins all_moves_bram_axi_ctrl/s_axi_aresetn] [get_bd_pins am_axi_register_slice/aresetn] [get_bd_pins ctrl0_axi_to_bram/s_axi_aresetn] [get_bd_pins q_axi_bram_ctrl/s_axi_aresetn] [get_bd_pins rst_digclk_ddr4_users/peripheral_aresetn]
  ...
  connect_bd_net -net ps_e_pl_clk0 [get_bd_ports digclk] [get_bd_pins all_moves_bram_axi_ctrl/s_axi_aclk] [get_bd_pins am_axi_register_slice/aclk] [get_bd_pins ctrl0_axi_to_bram/s_axi_aclk] [get_bd_pins fan_ctrl_fifo/wr_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/maxihpm1_fpd_aclk] [get_bd_pins ps_e/pl_clk0] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins q_axi_bram_ctrl/s_axi_aclk] [get_bd_pins rst_digclk_ddr4_users/slowest_sync_clk]
  ...
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces trans_axi] [get_bd_addr_segs ps_e/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces trans_axi] [get_bd_addr_segs ps_e/SAXIGP3/HP1_QSPI] -force
  ...
  set_property PFM_NAME {xilinx.com:xd:kr260_som:1.0} [get_files [current_bd_design].bd]
  set_property PFM.AXI_PORT {S_AXI_HP0_FPD { memport "S_AXI_HP" sptag "HP0" memory "ps_e HP0_DDR_LOW" } S_AXI_HP2_FPD { memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW" } S_AXI_HPC0_FPD { memport "S_AXI_HPC" sptag "HPC0" memory "ps_e HPC0_DDR_LOW" } S_AXI_HPC1_FPD { memport "S_AXI_HPC" sptag "HPC1" memory "ps_e HPC1_DDR_LOW" } } [get_bd_cells /ps_e]
  set_property PFM.CLOCK {pl_clk0 {id "3" is_default "true" proc_sys_reset "/rst_digclk_ddr4_users" status "fixed" freq_hz "299997009"}} [get_bd_cells /ps_e]
