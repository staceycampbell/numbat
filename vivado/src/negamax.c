...
static int32_t bins [64];
static uint32_t negvals;
        ...
        int32_t pv_index)
{
        ...
        {
                // hash = vchess_trans_hash(0);
                // trans_trans = vchess_read(253);
